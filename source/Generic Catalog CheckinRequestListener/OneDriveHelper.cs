...
namespace CheckinRequestListener
{
    public static class OneDriveHelper
    {
		...
		public static string UploadRest(string baseUrl, string folderUrl, string filePath)
		{
		...
		{
			string url = "https://inrulechicago-my.sharepoint.com";

			/// SharePoint Folder Relative Url
			string folderUrl = "InRuleCICD";
